...
function RouterApi(tokenConf, idmcore, router) {
    ...
    // curl -H "Authorization: bearer nNGNryDDZ4zQYeWYGYcnOdxJ90k9s6" 'http://localhost:3000/api/v1/policies/entity/sensor/sensor-id'
    ...
    router.route('/policies/entity/:entity_type/:entity_id').get(
    ...
    router.route('/policies/entity/:entity_type/:entity_id/policy/:policy_name').put(
        passport.authenticate('agile-bearer', {
            session: false
        }),
        bodyParser.json(),
    ...
    //curl -H "Content-type: application/json" -H "Authorization: bearer L1q8RdPhqhpcNJR9YRKpfVbie0fZxM31JRW9PPmCcvcLsatWrJBbawzfgDwACH9S" -XDELETE 'http://localhost:3000/api/v1/policies/entity/sensor/mysensor/policy/name'
    router.route('/policies/entity/:entity_type/:entity_id/policy/:policy_name').delete(
        passport.authenticate('agile-bearer', {
            session: false
        }),
        bodyParser.json(),
